...
export function LPs() {
  ...
  const paths = ["Individual Venture Office", "Club Deal Readiness", "CVC Portfolio Office", "Fund Formation Readiness"];
    ...
    <div className="pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-20 lg:pb-24 px-6 sm:px-8 lg:px-12">
      <div className="max-w-[1200px] mx-auto">
        <section className="rounded-[28px] sm:rounded-[32px] bg-gradient-to-br from-[#1a1d26]/70 via-[#12141a]/85 to-[#1a1d26]/70 border border-white/[0.06] p-8 sm:p-12 mb-16">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4"><PillButton to="/contact?interest=lp-portfolio-setup" variant="primary">Start portfolio setup</PillButton><Link to="/trust-center" className="text-[13px] text-muted-foreground/60 hover:text-foreground/85 transition-colors">Review trust model →</Link></div>
        </section>

        <section className="mb-16"><span className="text-[12px] text-muted-foreground/50 font-light uppercase tracking-wider">Thesis focus</span><h2 className="text-[26px] sm:text-[34px] font-light tracking-tight text-foreground/90 mt-3 mb-8">The LP mandate is built around a focused venture thesis.</h2><div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">{focus.map((item) => <div key={item} className="rounded-[20px] bg-gradient-to-br from-[#1a1d26]/50 via-[#12141a]/60 to-[#1a1d26]/50 border border-white/[0.06] p-5 text-[14px] text-foreground/84 font-light">{item}</div>)}</div></section>

        <section className="rounded-[26px] bg-gradient-to-br from-[#1a1d26]/45 via-[#12141a]/55 to-[#1a1d26]/45 border border-white/[0.06] p-8 sm:p-10"><span className="text-[12px] text-muted-foreground/50 font-light uppercase tracking-wider">LP paths</span><h2 className="text-[26px] sm:text-[34px] font-light tracking-tight text-foreground/90 mt-3 mb-8">Four entry points, one operating standard.</h2><div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">{paths.map((item) => <div key={item} className="rounded-[18px] bg-white/[0.025] border border-white/[0.05] p-5 text-[13px] sm:text-[14px] text-muted-foreground/70 font-light leading-relaxed">{item}</div>)}</div></section>
      </div>
    </div>
  );
}
