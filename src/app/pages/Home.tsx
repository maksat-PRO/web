...
export function Home() {
  const platformPillars = [
    {
      ...
      description:
        "A staged mandate to define your thesis, build a pipeline, run due diligence, prepare IC materials, and set up reporting before any formal fund or SPV commitment.",
      link: "/lps",
      linkLabel: "Follow the LP path →",
    },
    {
      label: "For corporates",
      title: "CVC launch without fund theater",
      description:
        "A practical launch sprint for groups that need startup scouting, pilot logic, governance, budget, IC process, and board-level reporting before a permanent vehicle exists.",
      link: "/cvc",
    ...
    },
    {
      ...
      description:
        "We package selected founders for international diligence: narrative, data room, compliance readiness, market-entry logic, and partner introductions.",
      link: "/founders",
  ...
  const programs = [
    {
      title: "LP Portfolio Setup",
      duration: "30–45 days",
      outcome:
        "LP profile, thesis, governance choices, service/advisory mandate, first reporting workspace, and pipeline criteria.",
    },
    {
      title: "Startup Scouting Sprint",
      duration: "4–8 weeks",
      outcome:
        "Longlist, founder intake, scoring, shortlist, first conversations, red flags, and fit notes for the LP thesis.",
    },
    {
      title: "Due Diligence as a Service",
      duration: "Per deal",
      outcome:
        "Investment memo, data-room review, risk map, founder references, market notes, and IC-ready recommendation.",
    },
    {
      title: "CVC Launch Sprint",
      duration: "90 days",
      outcome:
        "Mandate, governance, budget, strategic thesis, first scouting sprint, pilot logic, and board materials.",
    },
    {
      title: "Fund Formation Readiness",
      duration: "8–12 weeks",
      outcome:
        "Counsel coordination, structure options, LP onboarding materials, reporting model, and data-room preparation.",
    },
  ];

  const lpOffers = [
    {
      title: "Individual LP Venture Office",
      ticket: "Advisory / setup mandate",
      structure: "A dedicated workstream for one LP or family office.",
      link: "/lps",
    },
    {
      title: "Club Deal / SPV Readiness",
      ticket: "Deal-by-deal logic",
      structure: "Pipeline, diligence, memo, allocation, and reporting support.",
      link: "/lps",
    },
    {
      title: "CVC Launch",
      ticket: "Corporate mandate",
      structure: "Strategic scouting, pilots, IC process, and board reporting.",
      link: "/cvc",
    },
    {
      title: "Classic Fund Readiness",
      ticket: "Subject to counsel",
      structure: "Preparation for future fund, LP materials, and operating model.",
      link: "/fund",
    },
  ];
    ...
    <div className="pt-16 sm:pt-20">
      <section className="relative min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            ...
            style={{ background: "radial-gradient(circle at 50% 0%, rgba(88, 91, 112, 0.15) 0%, transparent 70%)" }}
          />
        </div>
        <motion.div
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-white/[0.03] border border-white/[0.06]">
                  ...
                  <span className="text-[12px] sm:text-[13px] text-muted-foreground/70 font-light uppercase tracking-wider">
                    Venture office for LPs, family offices, and corporate groups
                  </span>
                </div>
                <h1 className="text-[36px] sm:text-[44px] lg:text-[58px] leading-[1.08] tracking-[-0.03em] mb-5 sm:mb-6">
                  <span className="text-foreground/95 font-light block">Build a venture portfolio</span>
                  <span className="text-foreground/95 font-light block">before committing to</span>
                  <span className="text-foreground/95 font-light block">a full fund structure</span>
                </h1>
                <p className="text-[13px] sm:text-[15px] text-muted-foreground/70 font-light tracking-tight mb-8 sm:mb-10 leading-relaxed max-w-2xl">
                  maksat.PRO helps LPs move from interest in venture to an executable portfolio mandate: thesis design, startup scouting, due diligence, IC materials, data room, reporting, and a legally reviewed path toward SPVs, CVC programs, or future fund vehicles.
                </p>
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-10 sm:mb-14">
                  <PillButton to="/lps" variant="primary" icon={<div className="w-2 h-2 rounded-full bg-foreground/60" />} className="w-full sm:w-auto justify-center">
                    Build LP portfolio
                  </PillButton>
                  <PillButton to="/contact?interest=lp-materials" variant="secondary" className="w-full sm:w-auto justify-center">
                    Request LP memo
                  </PillButton>
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  <ProofChip>LP portfolio setup</ProofChip>
                  <ProofChip>Scouting + DD</ProofChip>
                  <ProofChip>Reporting workspace</ProofChip>
                  <ProofChip>Counsel-ready process</ProofChip>
                </div>
              </div>
      ...
      <section className="max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20 lg:py-24">
        <div className="flex flex-col gap-3 mb-8 sm:mb-12">
          <span className="text-[12px] text-muted-foreground/50 font-light uppercase tracking-wider">What LPs actually need</span>
          <h2 className="text-[28px] sm:text-[36px] lg:text-[44px] font-light tracking-tight text-foreground/90 max-w-3xl leading-tight">
            Not a vague venture brand. A controlled path from thesis to portfolio.
          </h2>
          <p className="text-[13px] sm:text-[15px] text-muted-foreground/65 font-light leading-relaxed max-w-3xl">
            The site now routes capital partners into a concrete working process: decide the mandate, test deal flow, review diligence, approve opportunities, and only then formalize the correct legal wrapper.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-[28px] sm:text-[34px] font-light tracking-tight text-foreground/90 mt-3 mb-4 leading-tight">
                Every LP conversation should end with a clear next document.
              </h2>
              <p className="text-[13px] sm:text-[15px] text-muted-foreground/70 font-light leading-relaxed">
                Instead of asking an LP to “invest now”, we move toward a portfolio setup mandate, data-room access, a defined thesis, and deal-flow evidence.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-8">
            <div>
              ...
              <h2 className="text-[26px] sm:text-[32px] font-light tracking-tight text-foreground/90 mt-3 mb-3">
                What we can sell and deliver now.
              </h2>
              <p className="text-[14px] text-muted-foreground/60 font-light max-w-2xl leading-relaxed">
                Before a permanent vehicle is formed, maksat.PRO can work through advisory, venture office, scouting, due diligence, reporting, and setup mandates.
              </p>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-[26px] sm:rounded-[28px] bg-gradient-to-br from-[#1a1d26]/40 via-[#12141a]/50 to-[#1a1d26]/40 border border-white/[0.06] p-8 sm:p-10">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-8">
            <div>
              ...
              <p className="text-[14px] text-muted-foreground/60 font-light max-w-2xl leading-relaxed">
                The first paid step should be a controlled working mandate, not a rushed fund commitment. Each entry point can later connect to an SPV, CVC, fund, or mono-LP vehicle after legal review.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-[26px] sm:text-[34px] font-light tracking-tight text-foreground/90 mt-3 mb-4">
                The LP must feel control, not pressure.
              </h2>
              <p className="text-[13px] sm:text-[15px] text-muted-foreground/70 font-light leading-relaxed">
                The first conversion is not “send money”. It is “request the LP memo, review the process, and define a mandate”.
              </p>
            </div>
