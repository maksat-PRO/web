        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-16 sm:mb-20 lg:mb-24">
          <div className="relative rounded-[28px] sm:rounded-[32px] bg-gradient-to-br from-[#1a1d26]/70 via-[#12141a]/85 to-[#1a1d26]/70 border border-white/[0.06] backdrop-blur-2xl overflow-hidden">
            ...
            <div className="relative px-6 sm:px-10 lg:px-12 py-10 sm:py-12">
              <div className="inline-flex items-center gap-2 mb-5"><div className="w-1.5 h-1.5 rounded-full bg-foreground/70" /><span className="text-[12px] sm:text-[13px] text-muted-foreground/60 font-light uppercase tracking-wider">Downloadable founder memo</span></div>
              <h1 className="text-[36px] sm:text-[48px] lg:text-[64px] font-light tracking-tight text-foreground/95 mb-5 sm:mb-6 leading-tight max-w-4xl">Founder Readiness Score</h1>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 print:hidden"><button onClick={handlePrint} className="inline-flex items-center justify-center rounded-full border border-white/10 bg-white/10 px-5 py-2.5 sm:px-6 sm:py-3 text-[13px] sm:text-[14px] text-foreground/95 font-light hover:bg-white/15 transition-colors w-full sm:w-auto">Print / save as PDF</button><Link to="/founders" className="inline-flex items-center justify-center rounded-full border border-white/5 px-5 py-2.5 sm:px-6 sm:py-3 text-[13px] sm:text-[14px] text-muted-foreground/80 font-light hover:bg-white/5 hover:text-foreground/90 transition-colors w-full sm:w-auto">Submit founder application</Link></div>
            </div>
          </div>
        </motion.div>

        <section className="mb-16 sm:mb-20 lg:mb-24"><h2 className="text-[26px] sm:text-[32px] lg:text-[36px] font-light tracking-tight text-foreground/90 mb-8 sm:mb-12">Scoring framework</h2><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">{scoreFactors.map((factor) => <div key={factor.title} className="rounded-[22px] sm:rounded-[24px] bg-gradient-to-br from-[#1a1d26]/50 via-[#12141a]/60 to-[#1a1d26]/50 border border-white/[0.06] p-6 sm:p-8"><div className="text-[11px] text-muted-foreground/40 font-light uppercase tracking-wider mb-3">Weight {factor.weight}</div><h3 className="text-[20px] sm:text-[24px] text-foreground/90 font-light tracking-tight mb-5">{factor.title}</h3><div className="space-y-3">{factor.checks.map((item) => <div key={item} className="flex gap-3 text-[13px] sm:text-[14px] text-muted-foreground/70 font-light leading-relaxed"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-foreground/45" /><span>{item}</span></div>)}</div></div>)}</div></section>

        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-16 sm:mb-20 lg:mb-24"><div className="rounded-[26px] sm:rounded-[28px] bg-gradient-to-br from-[#1a1d26]/40 via-[#12141a]/50 to-[#1a1d26]/40 border border-white/[0.06] p-6 sm:p-8"><h2 className="text-[24px] sm:text-[30px] font-light tracking-tight text-foreground/90 mb-6">Founder intake checklist</h2><div className="space-y-3">{intake.map((item) => <label key={item} className="flex gap-3 text-[13px] sm:text-[14px] text-muted-foreground/70 font-light leading-relaxed"><input type="checkbox" className="mt-1 h-4 w-4 rounded border-white/20 bg-white/[0.03]" /><span>{item}</span></label>)}</div></div><div className="rounded-[26px] sm:rounded-[28px] bg-gradient-to-br from-[#1a1d26]/40 via-[#12141a]/50 to-[#1a1d26]/40 border border-white/[0.06] p-6 sm:p-8"><h2 className="text-[24px] sm:text-[30px] font-light tracking-tight text-foreground/90 mb-6">Score bands</h2><div className="space-y-4">{bands.map((band) => <div key={band.range} className="rounded-[18px] bg-white/[0.025] border border-white/[0.05] p-5"><div className="text-[11px] text-muted-foreground/40 font-light uppercase tracking-wider mb-2">{band.range}</div><h3 className="text-[17px] text-foreground/86 font-light mb-2">{band.label}</h3><p className="text-[12px] sm:text-[13px] text-muted-foreground/65 font-light leading-relaxed">{band.description}</p></div>)}</div></div></section>
