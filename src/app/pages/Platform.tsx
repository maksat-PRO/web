...
export function Platform() {
  const modules = [
    { title: "Sourcing", description: "Founder discovery, ecosystem maps, referral tracking, event intelligence, founder intake, and signal capture across CIS, Central Asia, MENA, EU, and US corridors." },
  ...
  const workflows = ["Deal-flow intake and founder intelligence", "AI-assisted memo drafting and comparison", "Diligence task management and evidence tracking", "IC agenda, voting, approvals, and decision archive", "LP and CVC reporting with clear status logic", "Portfolio monitoring, follow-on signals, and exit preparation"];
