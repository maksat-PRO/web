          ...
          <div className="relative px-3.5 sm:px-5 lg:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-3">
            <Link to="/" className="flex items-center gap-3 group min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="hidden sm:block text-[11px] leading-tight text-muted-foreground/58 font-light truncate">LPs · Founders · Fund OS</div>
              </div>
            </Link>
